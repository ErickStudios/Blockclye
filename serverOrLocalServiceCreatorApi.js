let serverRun = (fileToLoad) => {
    ...
    const { exportLibrary, parse, run, tokenize, createEnum } = require("./core/mapIndividualServices/mapServerScriptServiceLang")
    ...
    let createRuntimeLib = () => {
        ...
        */
        lib.RigidPart = { type: 'func', func: (params) => {
        ...
        */
        lib.StaticPart = { type: 'func', func: (params) => {
            let blk = SimpleBlk.func([
                lib.Vector3.func([0,0,0]),
                lib.Vector3.func([1,1,1]),
                lib.Vector3.func([0,0,0]),
